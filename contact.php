...
<head>
    ...
    <title>Contact | Online Tailor</title>
            ...
            <li style="padding-top: .3rem;">
                <div style="background-color: #b18b22; border-radius: 4px;">
                    <form class="form-inline ">
                        <input class="form-control form-control-sm mr-3 w-75" type="text" placeholder="Search" aria-label="Search" style="border-radius: 2px;">
...
<body>
    ...
    <div class="about-section">
        <h1>Our Team Contact</h1>
        <p>Feel Free to contact with us.</p>
        <p>Our customer is our First priority we are pleasure to deal with you.</p>
    </div>
    ...
    <div class="row ">
        <div class="column col-lg-4 col-md-4 col-sm-6">
            <div class="card">
                <img src="images/awais.jpg" alt="Jane" style="width:100%">
                <div class="container">
                    <h2>Awais Ikram</h2>
                    <p class="title">CEO & Founder</p>
                    <p>Hi! My name is Awais. Feel free to contact with me.</p>
                    <p>Awaisikram788@gmail.com</p>
                    <p><a href="https://api.whatsapp.com/send?phone=+923344129684"><button class="button">Contact</button></a></p>
                </div>
            </div>
        </div>
        ...
        <div class="column col-lg-4 col-md-4 col-sm-6">
            <div class="card">
                <img src="images/taimoor.jpg" alt="Mike" style="width:100%">
                <div class="container">
                    <h2>Taimoor Hassan</h2>
                    <p class="title">CEO & CO-Founder</p>
                    <p>Hi! My name is Taimoor. Feel free to contact with me.</p>
                    <p>king.taimoor98.th@gmail.com</p>
                    <p><a href="https://api.whatsapp.com/send?phone=+923174585625"><button class="button">Contact</button></a></p>
                </div>
            </div>
        </div>
        ...
        <div class="column col-lg-4 col-md-4 col-sm-6">
            <div class="card">
                <img src="images/sultan.jpg" alt="John" style="width:100%">
                <div class="container">
                    <h2>Sultan Khan</h2>
                    <p class="title">Head Tailor</p>
                    <p>Hi! My name is Sultan. Feel free to contact with me.</p>
                    <p>Sultankhan@gmail.com</p>
                    <p><a href="https://api.whatsapp.com/send?phone=+923333366631"><button class="button">Contact</button></a></p>
                </div>
            </div>
        </div>
    </div>
