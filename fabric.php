...
<head>
    ...
    <title>Fabrics | Online Tailor</title>
...
<body>
    ...
    <div class="our_work ">
        ...
        <div class="card " style="width: 15rem; height: 20rem;">
            ...
            <div class="card-body">
                <p class="card-text cinfo">
                    Gender : Male <br> Type : Kurta <br> Pricing start from : 0.0 Rs <br>
                    <small>More</small></p>
            </div>
        </div>
        <div class="card " style="width: 15rem; height: 20rem;">
            ...
            <div class="card-body">
                <p class="card-text cinfo">
                    Gender : Female <br> Type : Kurti <br> Pricing start from : 0.0 Rs <br>
                    <small>More</small></p>
            </div>
        </div>
        <div class="card " style="width: 15rem; height: 20rem;">
            ...
            <div class="card-body">
                <p class="card-text cinfo">
                    Gender : Male <br> Type : Trouser's <br> Pricing start from : 0.0 Rs <br>
                    <small>More</small></p>
            </div>
        </div>
        <div class="card " style="width: 15rem; height: 20rem;">
            ...
            <div class="card-body">
                <p class="card-text cinfo">
                    Gender : Female <br> Type : plazzo <br> Pricing start from : 0.0 Rs <br>
                    <small>More</small></p>
            </div>
        </div>
        <div class="card " style="width: 15rem; height: 20rem;">
            ...
            <div class="card-body">
                <p class="card-text cinfo">
                    Gender : Male <br> Type : Jeans <br> Pricing start from : 0.0 Rs <br>
                    <small>More</small></p>
            </div>
        </div>
        <div class="card " style="width: 15rem; height: 20rem;">
            ...
            <div class="card-body">
                <p class="card-text cinfo">
                    Gender : Female <br> Type : Bridal <br> Pricing start from : 0.0 Rs <br>
                    <small>More</small></p>
            </div>
        </div>
        <div class="card " style="width: 15rem; height: 20rem;">
            ...
            <div class="card-body">
                <p class="card-text cinfo">
                    Gender : Male <br> Type : Pent Coat <br> Pricing start from : 0.0 Rs <br>
                    <small>More</small></p>
            </div>
        </div>
        <div class="card " style="width: 15rem; height: 20rem;">
            ...
            <div class="card-body">
                <p class="card-text cinfo">
                    Gender : Female <br> Type : frok <br> Pricing start from : 0.0 Rs <br>
                    <small>More</small></p>
            </div>
        </div>
